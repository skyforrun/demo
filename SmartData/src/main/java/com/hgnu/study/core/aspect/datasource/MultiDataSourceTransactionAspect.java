package com.hgnu.study.core.aspect.datasource;

/**
 * @author zj
 * @Description: 多数据源事务切面
 * @date 2020/11/1716:34
 */

import com.hgnu.study.core.annotation.MultiDataSourceTransactional;
...
public class MultiDataSourceTransactionAspect {
     ...
     * 切面
     */
    @Pointcut("@annotation(com.hgnu.study.core.annotation.MultiDataSourceTransactional)")
